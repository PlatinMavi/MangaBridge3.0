...
export default function Lasttw({number,manga,fansub}){
    return(
        <Link to={`/manga/${manga.browser}`} className="mx-12 scale-80 md:scale-100 md:-translate-x-0 -translate-x-2 font-mono">
            <div className="flex relative min-w-xl">
                <img src={"http://localhost:4000/Collection/"+manga.image} alt="" className="h-64 object-cover rounded-l-xl w-44 shadow-xl" />
