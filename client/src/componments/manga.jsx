    ...
    return(
        <Link to={`/manga/${browser}`} className="mx-12 font-mono ">
            <div className="flex relative min-w-xl">
                <img src={image} alt="" className="h-64 rounded-l-xl w-44 shadow-xl" />
                <div className="bg-white bg-opacity-5 shadow-xl overflow-hidden backdrop-blur-sm h-64 p-4 text-right w-56 drop-shadow-lg rounded-r-xl absolute left-3/4">
